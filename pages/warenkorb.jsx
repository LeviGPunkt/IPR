...
export default function Warenkorb() {
  ...
  const clientID = "AXLNsVKDqmgGhdZ8BAZR_emtIeUQwFGxe8Zf6fNFDpowHcI6C9AobtSoieSLRnuAGZockg97HlD_ryOu"
                ...
                <tbody>
                  {warenkorb.produkte.map((produkt) => (
                    <tr key={produkt._id}>
                      ...
                      <td>
                      <Link href={`/produkte/${produkt.url}`} className='text-danger' style={{ textDecoration: 'none' }}>
                          {produkt.name}
                      </Link>
